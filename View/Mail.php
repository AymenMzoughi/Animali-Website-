          ...
          <form method="post" >
            <div class="row">
              ...
              <div class="form-group col-lg-12">
                <textarea name="body" class="form-control" placeholder="Type your message"  id="message" rows="8"></textarea>
              </div>
            </div>
...
$mail ->SMTPAuth=true;
$mail ->Username="mtacit2@gmail.com";
$mail ->Password='aymenultras123';
$mail ->Port=465;
$mail ->SMTPSecure='ssl';
$mail->isHTML(true);
