    ...
    <div class="wrapper">
        ...
        <div class="main">
          ...
          <i class="hamburger align-self-center"></i>
            ...
            <main class="content">
            <form  method="POST" action="supp-cartefid.php"   id="supprimercartefid" name="supprimercartefid">
                        ...
                        <div class="col-12 col-xl-6">
                            ...
                            <div class="card-body card-block">
                                              ...
                                              <div class="row form-group">
                                                     <div class="col col-md-3"><label for="text-input" class=" form-control-label">ID Carte Fidelité</label></div>
                                                     <div class="col-12 col-md-9"><input type="text" name="IDC" id="IDC" class="form-control"><small class="form-text text-muted"></small></div>
