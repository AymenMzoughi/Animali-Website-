...
<head>
    ...
    <link href="../back/examples/css/app.css" rel="stylesheet">
</head>
    ...
    <div class="wrapper">
        <nav id="sidebar" class="sidebar">
          ...
          <span class="align-middle">AdminKit</span>
              ...
              <i class="align-middle" data-feather="credit-card"></i> <span class="align-middle">Gestion des Livreurs</span>
            </a>
                    </li>
              ...
              <i class="align-middle" data-feather="briefcase"></i> <span class="align-middle">Gestion des Livreurs</span>
            </a>
                        <ul id="ui" class="sidebar-dropdown list-unstyled collapse " data-parent="#sidebar">
						<li class="sidebar-item"><a class="sidebar-link" href="ajouterprod.php">Ajouter Livreur</a></li>
							<li class="sidebar-item"><a class="sidebar-link" href="ui-buttons.html">Modifier Livreur</a></li>
							<li class="sidebar-item"><a class="sidebar-link" href="ui-cards.html">Supprimer Livreur</a></li>
							<li class="sidebar-item"><a class="sidebar-link" href="affich-livreur.php">Afficher Livreur</a></li>
                        </ul>
                    </li>
