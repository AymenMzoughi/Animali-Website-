      ...
      <div class="andro_auth-wrapper">
        ...
        <div class="andro_auth-form">
          ...
          <form  method="POST" action="ajout-client.php"   id="ajouterclient" name="ajoutrclieent">
            ...
            <div class="form-group">
              <select class="form-control"  placeholder="Sexe" name="Sexe" id="Sexe" >
            ...
            <div class="form-group">
              <input type="text" class="form-control" placeholder="Name" name="Nom" id="Nom">
            </div>
            
            <div class="form-group">
              <input type="text" class="form-control" placeholder="Lastname" name="Prenom" id="Prenom">
            </div>

            <div class="form-group">
              <input type="text" class="form-control" placeholder="Phone Number" name="NumTel" id="NumTel">
            </div>

            <div class="form-group">
              <input type="email" class="form-control form-control-light" placeholder="Email Address" name="Email" id="Email">
            </div>
            
            <div class="form-group">
              <input type="text" class="form-control" placeholder="Adresse" name="ADR" id="ADR">
            </div>
            <div class="form-group">
              <input type="date" class="form-control" placeholder="Birth date" name="DNS" id="DNS">
            </div>
            <div class="form-group">
              <input type="password" class="form-control" placeholder="Password" name="MDP" id="MDP">
            </div>
            <button type="submit"  class="andro_btn-custom btn-sm shadow-none" onclick="Client()==true">Sign Up</button>
