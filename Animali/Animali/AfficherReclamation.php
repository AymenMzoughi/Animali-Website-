...
// On teste si la variable de session existe et contient une valeur
   ...
   $listerecla = $reclamationC->recupereridclient($_SESSION['id']);
...
<aside class="andro_aside andro_aside-right">
  ...
  <div class="section">
    ...
    <h1 class="h8 mb-5"> Details sur mes Reclamations  </h1>
...
<tr>
<th style="width:14.28%;">ID Reclamation</th>
<th style="width:14.28%;">Sujet </th>
<th style="width:14.28%;"> Probleme </th>
<th style="width:14.28%;">Etat </th>
<th style="width:14.28%;"> id client </th>

</tr>

<?PHP
foreach($listerecla as  $cartefidC){
?>
<tr>
<td><?PHP echo $cartefidC['id']; ?></td>
<td><?PHP echo $cartefidC['sujet']; ?></td>
<td><?PHP echo $cartefidC['probleme']; ?></td>
<td><?PHP echo $cartefidC['etat']; ?></td>
<td><?PHP echo $cartefidC['idclient']; ?></td>
</tr>
<?PHP
}
?>
