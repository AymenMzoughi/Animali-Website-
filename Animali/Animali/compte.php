...
<body>
      ...
      <div class="andro_subheader-inner">
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="ajouterprodfront.php">Shop</a></li>
  ...
  <div class="section">
    ...
    <h1 class="h8 mb-5"> My ACCOUNT </h1>
    <hr>
    <h1 class="h6 mb-12">Bienvenue sur votre page d'accueil. Vous pouvez y gérer vos informations personnelles ainsi que vos commandes. </h1>
    <br>

    
    <center>
    <div >
<a type="button" class="andro_btn-custom shadow-none btn-sm" href="AjouterReclamation.php"   >Ajouter une réclamation</a>
</div>
<br>
<div >
<a type="button" class="andro_btn-custom shadow-none btn-sm" href="AfficherReclamation.php"   > Afficher les réclamations</a>
</div>

<div >
<br>
<a type="button" class="andro_btn-custom shadow-none btn-sm"  href="cartefid.php"   >Mes points fidelites </a>
</div>
...
<br>
<hr>
<a type="button" class="btn btn-outline-primary"  href="logout.php" name="button"  >Logout</a>
</center>
</div>
