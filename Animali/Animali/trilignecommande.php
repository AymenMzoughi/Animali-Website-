	...
	<div class="andro_subheader-inner">
	  ...
	  <nav aria-label="breadcrumb">
		<ol class="breadcrumb">
		  ...
		  <li class="breadcrumb-item active" aria-current="page">liste triée</li>
		</ol>
	  </nav>
	</div>
  </div>
  ...
  <div class="container">
            ...
            <main class="content">
				...
				<div class="card-body text-center">
					...
					<h1 class="h3 mb-3">Liste des commandes triee par id commande : </h1>
							...
							<div class="card">
				             ...
				             if(!$con)
                             {
                               die("probleme de connexion".mysqli_connect_error());
                                 ...
                                 $sql="SELECT idcommande, date_commande, produits, prix, id_client FROM commande ORDER BY idcommande";
                              ...
                              echo "date commande : " .$row["date_commande"]. " | id produit : ".$row["produits"]. " | prix : ".$row["prix"]. " | id client : ".$row["id_client"].  "<br/>";
