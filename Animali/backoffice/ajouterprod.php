          ...
          <span class="align-middle">Animali Backoffice</span>
              ...
              <i class="align-middle" data-feather="briefcase"></i> <span class="align-middle"> Gestion des Produits </span>
						...
						<ul id="ui" class="sidebar-dropdown list-unstyled collapse show" data-parent="#sidebar">
							...
							<li class="sidebar-item  active "><a class="sidebar-link" href="ajouterprod.php"> Ajouter  Produit  </a></li>
        ...
        <div class="main">
            ...
            <main class="content">
                ...
                <div class="container-fluid p-0">
                    ...
                    <h1 class="h3 mb-3">Ajouter un produit </h1>
                    ...
                    <div class="row">
                           ...
                           <div class="col-12 col-xl-6">
							<div class="card">
								...
								<div class="card-body">
									<form  method="POST" action="ajout-prod.php"   id="ajouterproduit" name="ajoutrprod">
										<div class="form-group row">
											<label class="col-form-label col-sm-2 text-sm-right">refernce</label>
											<div class="col-sm-10">
												<input type="text" id="ref" name="ref" class="form-control" placeholder="text">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-form-label col-sm-2 text-sm-right">prix</label>
											<div class="col-sm-10">
												<input type="text" id="prix" name="prix" class="form-control" placeholder="text">
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input type="text" id="nomprod" name="nomprod"class="form-control" placeholder="text">
											</div>
										</div>
										<div class="form-group row">
