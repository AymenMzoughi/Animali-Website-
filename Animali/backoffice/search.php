...
$Liste=$lignecommandeC->rechercheridcommande($_POST["Search"]);
}
if($_POST["choix"]=='id produit')
{$lignecommandeC=new LignecommandeC();
$Liste=$lignecommandeC->rechercheridproduit($_POST["Search"]);
}
if($_POST["choix"]=='id cmd')
{$lignecommandeC=new LignecommandeC();
          ...
          <span class="align-middle">Animali Backoffice</span>
              ...
              <i class="align-middle" data-feather="shopping-cart"></i> <span class="align-middle"> Gestion des commandes </span>
						...
						<ul id="ui" class="sidebar-dropdown list-unstyled collapse show" data-parent="#sidebar">
							<li class="sidebar-item active"><a class="sidebar-link" href="search.php">  chercher Ligne de commande  </a></li>
...
<td>
<div >
<a type="button" class="btn btn-outline-primary" href = "modifier.php?idcommande=<?= $user['idcommande'] ?>">Modifier</a>
</div>  
</form>
</td>
</tr>
