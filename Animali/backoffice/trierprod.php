          ...
          <span class="align-middle">Animali Backoffice</span>
              ...
              <i class="align-middle" data-feather="briefcase"></i> <span class="align-middle"> Gestion des Produits </span>
						...
						<ul id="ui" class="sidebar-dropdown list-unstyled collapse show" data-parent="#sidebar">
							...
							<li class="sidebar-item active  "><a class="sidebar-link" href="trierprod.php">  trier les Produits  </a></li>
          ...
          <i class="hamburger align-self-center"></i>
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <h1 class="h3 mb-3">Liste produits triee par reference : </h1>
                            ...
                            <div class="card">
                             ...
                             if(!$con)
                             {
                               die("probleme de connexion".mysqli_connect_error());
                                 ...
                                 $sql="SELECT * FROM produits ORDER BY ref";
                              ...
                              echo "reference : " .$row["ref"].   "<br/>prix : ".$row["prix"]. "<br/>nomproduit : ".$row["nomprod"]. "<br/>descption : ".$row["descprod"]. "<br/>id categorie : ".$row["idcat"]. "<br/><br/><br/>";
