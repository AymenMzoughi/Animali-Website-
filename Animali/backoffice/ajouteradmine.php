...
<body>
    ...
    <nav id="sidebar" class="sidebar">
          ...
          <span class="align-middle">Animali Backoffice</span>
              ...
              <i class="align-middle" data-feather="shopping-cart"></i> <span class="align-middle">Gestion des  produits </span>
            </a>
					</li>
                    <li class="sidebar-item">
		...
		<div class="main">
          ...
          <i class="hamburger align-self-center"></i>
			...
			<div class="container-fluid p-0">
				...
				<h1 class="h3 mb-3">Ajouter un utilisateur </h1>
				...
				<div class="row">
					   ...
					   <div class="col-12 col-xl-6">
						<div class="card">
							...
							<div class="card-body">
								<form  method="POST" action="ajou-admine.php"   id="ajouterad" name="ajoutradd">
									...
									<div class="form-group row">
										...
										<div class="col-sm-10">
											<input type="text" id="login" name="login"class="form-control" placeholder="text">
										</div>
									</div>
									<div class="form-group row">
										<label class="col-form-label col-sm-2 text-sm-right">mot de passe</label>
										<div class="col-sm-10">
											<input type="text" id="password" name="password"class="form-control" placeholder="text">
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-10">
											<input type="text" id="image" name="image"class="form-control" placeholder="text">
										</div>
									</div>
        ...
        <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <h1 class="h3 mb-3">Afficher liste des utilisateurs </h1>
            ...
            ?>
                <tr>
                    ...
                    <td><?PHP echo $utilisateurC['login']; ?></td>
                    <td><?PHP echo $utilisateurC['password']; ?></td>
