	...
	<nav id="sidebar" class="sidebar">
          ...
          <span class="align-middle">Animali Backoffice</span>
              ...
              <i class="align-middle" data-feather="briefcase"></i> <span class="align-middle"> Gestion des Produits </span>
						...
						<ul id="ui" class="sidebar-dropdown list-unstyled collapse show" data-parent="#sidebar">
							<li class="sidebar-item active"><a class="sidebar-link" href="affichercat.php"> Ajouter categories </a></li>
		...
		<div class="main">
          ...
          <i class="hamburger align-self-center"></i>
            ...
            <main class="content">
            <form  method="POST" action="ajout-cat.php"   id="ajoutercategorie" name="ajoutcat">
                <div class="container-fluid p-0">

                    <h1 class="h3 mb-3">Ajouter categorie </h1>
