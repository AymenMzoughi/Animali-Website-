...
<body>
    ...
    <nav id="sidebar" class="sidebar">
          ...
          <span class="align-middle">Animali Backoffice</span>
              ...
              <i class="align-middle" data-feather="briefcase"></i> <span class="align-middle"> Gestion des Produits </span>
						...
						<ul id="ui" class="sidebar-dropdown list-unstyled collapse show" data-parent="#sidebar">
							...
							<li class="sidebar-item active  "><a class="sidebar-link" href="chercherprod.php">  chercher Produits  </a></li>
		...
		<div class="form-container">
            <form action="" method = 'POST'>
                <div class="row">
                    <div class="col-25">                
                        <label>Search reference by: </label>
                    </div>
                    <div class="col-75">
                        
                        <select name="choix">
                    <option>ref</option>
                    <option>nom prod</option>
                    </select>
                    <br>
	...
	<?php
		if (isset($_POST['produit']) && isset($_POST['search'])){
            if($_POST['choix']=="nom prod"){
                $result = $produitC->getProdByName($_POST['produit']);
            }
			else if($_POST['choix']=="ref"){
                $result = $produitC->getProdByRef($_POST['produit']);
            }
	...
	?>
		<section class="container">
			...
			<div class="shop-items">
				...
				<div class="shop-item">
                <td><strong class="shop-item-title"> <?= $result['ref'] ?> </strong>
                    </td>
					...
					<div class="shop-item-details">
                     ...
                     <td>
                    <div class="shop-item">
					<strong class="shop-item-title"> <?= $result['nomprod'] ?> </strong>
                    </td>

                    <td>
                    <div class="shop-item">
					<strong class="shop-item-title"> <?= $result['descprod'] ?> </strong>
                    </td>

                    <td>
                    <div class="shop-item">
					<strong class="shop-item-title"> <?= $result['idcat'] ?> </strong>
                    </td>
				</div>
                </tr>
                </table>
            ...
            <a href = "afficherprod.php" class="btn btn-primary shop-item-button">All products</a>
		</section>
	<?php
		}
		else {
