...
$listeUsers=$reclamationC->recupererReclamation($_POST["Search"]);
}
if($_POST["choix"]=='id client')
{$reclamationC=new ReclamationC();
$listeUsers=$reclamationC->recupereridclient($_POST["Search"]);
}
if($_POST["choix"]=='etat')
{$reclamationC=new ReclamationC();
$listeUsers=$reclamationC->rechercheretat($_POST["Search"]);
}
